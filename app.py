...
age = st.number_input("age", min_value=29, max_value=80, value=0, step=1)
...
trestbps = st.number_input("trestbps", min_value=94, max_value=200, value=0, step=1)
chol = st.number_input("chol", min_value=127, max_value=600, value=0, step=1)
fbs = st.number_input("fbs", min_value=0.0, max_value=1.0, value=0.0, step=0.1)
restecg = st.number_input("restecg", min_value=0.0, max_value=2.00, value=0.1, step=0.1)
thalach = st.number_input("thalach", min_value=71, max_value=250, value=20, step=1)
...
ca = st.number_input("ca", min_value=0.0, max_value=4.42, value=0.1, step=0.1)
thal = st.number_input("thal", min_value=0, max_value=3, value=20, step=1)
